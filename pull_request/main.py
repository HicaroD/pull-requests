...
from pull_request.exceptions import (
    CredentialFileDoesNotExist,
    InvalidFormatForCredentialFile,
)
...
async def main():
    try:
        ...
        print(
            "Error: Make sure your 'pr.json' file exists in the root directory of your project."
        )
